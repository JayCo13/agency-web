...
void mainImage(out vec4 o, vec2 C) {
  ...
  // Alpha follows brightness so empty areas are transparent — lets the streaks
  // sit on a light background instead of a black canvas.
  float a = clamp(max(colr.r, max(colr.g, colr.b)), 0.0, 1.0);
  o = vec4(colr, a * uOpacity);
}
